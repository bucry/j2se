...
public class SongInfoPanel extends JPanel implements MouseListener, Runnable {
    ...
    private static Logger log = Logger.getLogger(SongInfoPanel.class.getName());
    private SongInfo info;
    private long lastShow;//上一次显示一个项目的时间
    private String show = "YOYOPlayer";//要显示的字符串
    private String preShow = "YOYOPlayer";//以前显示的字符串，用来做动画用的
